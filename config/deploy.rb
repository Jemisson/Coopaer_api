...
# Repository project
set :application_name, 'coopaer_api'
set :domain, '108.181.224.45'
set :deploy_to, '/home/production/coopaer_api'
set :repository, 'git@github.com:Jemisson/Coopaer_api.git'
...
task :staging do
  ...
  set :domain, '108.181.224.45'
  set :deploy_to, '/home/development/coopaer_api'
  set :branch, 'master'
end
